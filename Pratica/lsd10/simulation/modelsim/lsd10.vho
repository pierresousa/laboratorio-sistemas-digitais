...
-- result[0]	=>  Location: PIN_F13,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- result[1]	=>  Location: PIN_D20,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
-- result[2]	=>  Location: PIN_J8,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: 24mA
...
-- x[1]	=>  Location: PIN_K5,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default
-- x[2]	=>  Location: PIN_H6,	 I/O Standard: 3.3-V LVTTL,	 Current Strength: Default


ARCHITECTURE structure OF lsd10 IS
...
\r3~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \r3~0_combout\ = \x~combout\(1) $ (\x~combout\(0))
...
\r4~0\ : cycloneii_lcell_comb
-- Equation(s):
-- \r4~0_combout\ = \x~combout\(2) $ (\x~combout\(0))
